...
export default function LoginPage() {
  return (
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <div className="flex flex-1 items-center justify-center px-5 sm:px-6 pb-8">
        <div className="w-full max-w-md space-y-6 sm:space-y-8">
          ...
          <div className="flex flex-col items-center">
            ...
            <h1 className="text-xl sm:text-2xl font-bold text-foreground">Bem-vindo de volta</h1>
            <p className="mt-1.5 sm:mt-2 text-sm sm:text-base text-muted-foreground">Entre na sua conta para continuar</p>
          </div>
          ...
          <form className="space-y-5 sm:space-y-6">
            <div className="space-y-1.5 sm:space-y-2">
              ...
              <Input
                ...
                className="h-11 sm:h-12 border-border bg-card text-foreground placeholder:text-muted-foreground text-sm sm:text-base"
              />
            </div>
            ...
            <Button type="submit" className="h-11 sm:h-12 w-full bg-primary text-primary-foreground hover:bg-primary/90 text-sm sm:text-base">
              Entrar
            </Button>
          </form>
